class Solution:
    def findMedianSortedArrays(self, nums1: List[int], nums2: List[int]) -> float:
        ...
        #we want to operate on the smaller array
        ...
        L = 0 
        R = m #partition point is on the cut, so there can be cut with all elements and 0 to the left
        ...
        while L <= R:
            ...
            nums1_left_max = float("-inf") if nums1_left_values == 0 else nums1[nums1_left_values - 1] #gurding null value with -inf and inf
